...
public class StudentScheduleController {
    ...
    public List<EnrollmentDTO> getTranscript(@RequestParam("studentId") int studentId) {
        ...
        for (Enrollment e : enrollments) {
            ...
            EnrollmentDTO dto = new EnrollmentDTO(
                    ...
                    (section != null) ? section.getSecId() : 0,
                    (section != null) ? section.getSectionNo() : 0,
                    (section != null) ? section.getBuilding() : "",
                    (section != null) ? section.getRoom() : "",
                    (section != null) ? section.getTimes() : "",
                    (course != null) ? course.getCredits() : 0,
                    (term != null) ? term.getYear() : 0,
                    (term != null) ? term.getSemester() : ""
            );
            result.add(dto);
        }
        return result;
    ...
    public EnrollmentDTO addCourse(
        ...
        // Send message to gradebook with the newly created enrollment
